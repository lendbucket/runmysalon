...
const APPS = [
  ...
  { id: "style-health", name: "StyleHealth", tag: "Group Health Insurance", icon: "favorite", dotColor: "#ff6b6b", features: ["Group rates as contractor", "Dental and vision included"], price: "$25", period: "/ month", live: true },
]
